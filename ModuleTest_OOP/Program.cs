...
namespace ModuleTest_OOP
{
    ...
    //   Створити двовимірний масив випадкових чисел заданого діапазону та виконати завдання згідно варіанту
    //    Розмірність масиву: 6x8
    //    Діапазон значeнь: 10-99
    //    Завдання:
    //    Знайти середнє значення в кожному рядку матриці.
    //    Поміняти місцями рядок, який містить перше входження
    //    мінімального середнього значення з рядком, який містить
    //    останнє входження максимального середнього значення
    class Program
    {
